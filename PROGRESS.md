...
| **R23.3** | Bridge Rust | Task routes /prompt /tool /action /connect /pending /result /heartbeat | `missing` | `in_progress` | opencode | 2026-09-22 claim. Same deal as R23.2 was: lands `blocked`/`unverified` here, verify on MSVC host. Deps: R23.2 |
