...
| **R22.3** | UI honesty | Wire Inspector inputs, guard empty diffs, drop re-throw | `missing` | `in_progress` | opencode | 2026-09-22 claim. Scope: new `UpdateClipVolumeCommand`; Exposure→Temperature (no engine exposure field); vocal checkbox removed (AudioWorkspace owns isolation). Deps: none |
