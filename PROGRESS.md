...
| **R21.2** | Agent | Planner honesty + LLM tool-schema exposure | `missing` | `in_progress` | opencode | 2026-09-22 claim (user-ordered; R21.1 code-complete pending PR/gate, no file overlap). Deps: R21.1 |
