...
[Audio Engine]: WebAudio Sub-frame Graph Initialized at 48000 Hz
 ...
 ✓ src/__tests__/vramPool.test.ts (7 tests) 13ms
...
[SAM 2 Engine]: Generating dynamic mask for click point (200, 300)...
 ...
 ✓ src/engine/frameCache.test.ts (4 tests) 8ms
...
Final offset after 60s playback: 0 seconds
 ...
 ✓ src/__tests__/audioMasterClock.test.ts (1 test) 125ms
...
[WebGPU Engine]: WebGPU Render Pipeline Initialized (32-bit Float Color Space)
 ...
 ✓ src/__tests__/tools.test.ts (9 tests) 10ms
...
[Auto-Reframe Engine]: Smoothing trajectory across 0 frames using Kalman filter...
 ...
 ✓ src/__tests__/autoReframe.test.ts (2 tests) 31ms
 ✓ src/engine/voiceIsolation.test.ts (1 test) 37ms
 ...
 ✓ src/engine/perception/vlm.test.ts (5 tests) 8ms
 ✓ src/__tests__/rationalTime.test.ts (1 test) 6ms
 ✓ src/engine/limiter.test.ts (2 tests) 8ms
 ✓ src/services/semanticSearch.test.ts (2 tests) 7ms
 ✓ src/engine/loudness.test.ts (2 tests) 44ms
 ...
 Test Files  31 passed (31)
   ...
   Start at  08:14:00
   Duration  4.43s (transform 1.10s, setup 0ms, collect 1.93s, tests 501ms, environment 9ms, prepare 2.80s)
